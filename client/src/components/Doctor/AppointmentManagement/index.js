...
const AppointmentsList=( { doctorId } ) =>
{
        ...
        const viewMoreDetails=async ( appointmentId ) =>
        {
                try
                {
                        const response=await axios.get( `/api/appointments/details/${ appointmentId }` );
                                        ...
                                        appointments.map( ( appointment ) => (
                                                <div key={ appointment.id } className={ styles.appointmentCard }>
                                                        ...
                                                        <div className={ styles.actions }>
                                                                <button
                                                                        className={ `${ styles.viewMoreButton } ${ styles.actionButton }` }
                        ...
                        { isModalOpen&&selectedAppointment&&(
                                <div className={ styles.modalOverlay }>
                                        <div className={ styles.modalContent }>
                                                ...
                                                <p><strong>Doctor's Notes:</strong> { selectedAppointment.doctor_notes }</p>
